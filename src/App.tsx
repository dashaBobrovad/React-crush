...
function App() {
  return (
    <div className="site">
      ...
      >
        <defs>
          {/* <symbol id="rightArrow" viewBox="0 0 10 18">
			<path d="M1 17L9 9L1 1" strokeLinecap="round" strokeLinejoin="round"/>
		</symbol> */}

          <symbol id="rightArrow" viewBox="0 0 25 25">
            <path d="m17.5 5.999-.707.707 5.293 5.293H1v1h21.086l-5.294 5.295.707.707L24 12.499l-6.5-6.5z" />
          </symbol>

          <symbol id="basket" viewBox="0 0 116.214 116.214">
            <g>
